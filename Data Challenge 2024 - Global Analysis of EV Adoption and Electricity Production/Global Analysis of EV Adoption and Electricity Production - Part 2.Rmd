...
- In general, the whole globe is moving towards the adoption of EVs. As evidenced by total vehicle sales, most people opt for BEVs, followed by PHEVs, and finally FCEVs. Naturally, with more demand comes more supply.
...
# Average temperature
temp <- read_csv("combined_temperature.csv") %>%
  filter(Country %in% c(
